...
## Conclusion
Even though the data sources come in with different formats, it can be easily imported with right libraries. From there, data cleaning and analysis can be done easily.
